		  ...
		  onPhotoDataSuccess: function(imageData) 
			...
			function populateDB2(tx) 
				...
				if(id_imagen!='')
					...
					{
					//alert ("insert");
					console.log("datos:"+tipo_local+"-----"+id_punto+"----"+id_tarea+"---");
					tx.executeSql("INSERT INTO checklist_imagen_cola(tipo,id_punto,punto,lugar,fecha_base,hora_base,ruta,id_campana,id_producto,estado,area) VALUES ('"+tipo_local+"','"+id_punto+"','','','"+fechabase+"','"+horabase+"','"+imageData+"','"+id_tarea+"','','PENDIENTE','TAREA')");
					}
